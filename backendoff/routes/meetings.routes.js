...
router.get('/tutor/:tutorId', authenticate, meetingController.getMeetingsByTutor);
router.put('/cancel/:meetingId', authenticate, meetingController.cancelMeeting);
...
router.post('/join-meeting/:meetingId', meetingController.joinMeeting);
